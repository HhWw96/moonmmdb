...
- 将核心包名从 `WeiR-h/moonmmdb` 统一为 `HhWw96/moonmmdb`，与公开仓库账号一致；同步示例依赖、导入、生成接口、Native 验证入口和 README。
- 旧包名的本地消费者需更新导入和依赖声明；核心功能和 0.2.0 API 保持不变，尚未发布 Mooncakes。

## 0.2.0 — 2026-09-16

- 五轮迭代：修复 JSONL 大整数重编码、输出积压与管道关闭处理。
