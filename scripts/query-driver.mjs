...
for (const request of requests) {
  ...
  results.push(JSON.parse(request.operation === 'metadata' ? metadata(handle) : request.operation === 'project' ? project(handle,request.ip,request.paths) : lookup(handle, request.ip)));
}
