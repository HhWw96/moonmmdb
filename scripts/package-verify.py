...
try:
    ...
    with zipfile.ZipFile(archive) as bundle:
        ...
        report['contains_scenario_licenses']=all(name in bundle.namelist() for name in ('LICENSE','THIRD_PARTY.md','tests/scenarios/manifest.json','native_cli/main.mbt','native_cli/io.c','native_cli/vendor/x/PROVENANCE.json','native_cli/licenses/MinGW-w64-runtime.txt','src/analytics/analytics.mbt','src/analytics/README.md','src/analytics_bridge/bridge.mbt','bin/analyze.mjs','native_cli/analyze.mbt','docs/ANALYTICS.md'))
