// Publication receipt reproducer: production code imports and uses both core and geo.
// This corrects the test-only geo import warning in the generic registry helper.
...
import {root,runMoon} from '../../../scripts/moon.mjs';
import {sha256} from '../../../scripts/evidence.mjs';
const version='0.6.0';
